...
// DrawingCanvasredrawCanvas 
// const DrawingCanvas = ({ onDrawingSubmit, disabled, timeRemaining }) => {
...
//       const newStroke = { ...prev, path: newPath };
...
//         <button onClick={submitDrawing} disabled={disabled} style={{ padding: '10px 30px', fontSize: '16px', backgroundColor: '#28a745', color: 'white', border: 'none', borderRadius: '5px' }}>
//           Submit Drawing
//         </button>

//         {timeRemaining !== null && (
//           <div style={{ marginTop: '10px', color: timeRemaining <= 10 ? 'red' : 'black', fontWeight: 'bold' }}>
...
const DrawingCanvas = ({ onDrawingSubmit, onCanvasChange, disabled, timeRemaining }) => {
  ...
  const stopDrawing = () => {
    ...
    if (currentStroke) {
      ...
      // Redraw canvas to ensure parent gets updated data
      redrawCanvas(newStrokes);
      
      // Also directly update parent to be extra sure
